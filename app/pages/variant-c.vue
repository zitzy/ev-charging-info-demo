<template>
  <div>
    <div class="mb-6">
      ...
      <p class="text-sm text-gray-500 mb-3">Variant C — Prehľad podľa kategórií</p>
      <DataFreshness
        v-if="pricing"
    ...
    <div v-else-if="pricing" class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-4">
      <VariantCCategoryView :pricing="pricing" />
    </div>
  </div>
</template>
